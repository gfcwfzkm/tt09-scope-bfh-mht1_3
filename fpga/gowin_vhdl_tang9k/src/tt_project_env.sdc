...
//Created Time: 2024-10-08 17:00:25
...
create_generated_clock -name hdmi_clock -source [get_nets {clk_50MHz}] -master_clock clk_50MHz -divide_by 2 [get_ports {pmod_hdmi_clk}]
